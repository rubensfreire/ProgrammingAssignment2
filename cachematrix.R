...
## to save unnecessary computational as long as the matrix doent change  
##
## How to Use:
## 1 - Call the cache support function makeVector passing an inversible as parameter:
##     my_matrix<-matrix(c(4,7,2,6),nrow=2,ncol=2)
##     my_matrix_vector<-makeCacheMatrix(my_matrix_vector)
##
...
## - From Second call() on, it retrives cached data
